...
public class DescriptionAdapter extends RecyclerView.Adapter<DescriptionAdapter.DescriptionViewHolder> {
    ...
    public DescriptionAdapter(Context context, List<Description> descriptions) {
        ...
        this.descriptions.add(NewDescriptionAddStub.getInstance());
    }
    ...
    private static class NewDescriptionAddStub extends Description {
        private NewDescriptionAddStub(@NonNull Bitmap thumbnail,
                                     @NonNull Metadata metadata,
                                     @NonNull String filename,
                                     @NonNull String hash) {
            super(thumbnail, metadata, filename, hash);
        }
        private static NewDescriptionAddStub getInstance(){
            return null;
        };
